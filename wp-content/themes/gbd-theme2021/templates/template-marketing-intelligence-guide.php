<?php
/*
  Template Name: Marketing Intelligence Guide
 *
    ...
    <main id="main" class="site-main" role="main">
      <div class="gbd-talk-to-expert">
        ...
        <section class="gbd-landing-page-banner">
          <div class="bg_cover-banner marketplace-banner landing-page-banner text-white">
        ...
        <section class="gbd-talk-to-expert-top-section">
         <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
              <div class="gbd-talk-to-expert-rt-content" id="gbd-talk-to-expert-rt-content">
                <div class="gbd-talk-to-expert-form">

                  <h2>Download your guide now and unlock your unified marketing intelligence opportunities</h2>
                  <?php
                    ...
                    <script>
                      var downloadPDF = function(){
                        a = document.createElement("a");
                            a.href =  "<?php echo get_template_directory_uri() . '/assets/pdf/Agencies Need Unified Marketing Intelligence to Give Brands an Edge.pdf'?>", a.download = "Agencies-Need-Unified-Marketing-Intelligence-to-Give-Brands-an-Edge.pdf", document.body.appendChild(a), a.click(), document.body.removeChild(a)
                     ...
                     function HubspotFormLoad(file) {
                      ...
                      script.onload = function() {
                              ...
                              if (document.querySelectorAll("#gbd-talk-to-expert-hb-form .hbspt-form").length == 0) {
                                  ...
                                  script1.innerHTML = "hbspt.forms.create({portalId: '5372895',formId: '<?php includeWithVariables('hubspotForms.php', array('formName'=>'Landing Page Form')); ?>',onFormSubmit: downloadPDF})";
             ...
             <div class="gbd-banner-talktoexpert-mob">
              <img src="<?php echo get_template_directory_uri()?>/assets/images/landing-page-img.png" alt="landing-page-img">                     
            </div>
          </div>
