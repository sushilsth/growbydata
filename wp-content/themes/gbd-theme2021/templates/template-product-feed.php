...
<div class="gbd-ad-intel-template gbd-solution-template">
  ...
  <section>
    <!-- GBD Static Banner -->
    <div class="bg_cover-banner marketplace-banner search-banner productfeed-banner text-white">
      <?php the_field('Productfeed slider'); ?>
    </div>
  </section>
  <!-- GBD Static Banner -->
    ...
    <div class=" odd bgwhite block-1">
      <?php if (have_rows('First-block')): ?>
        ...
        while (have_rows('First-block')): the_row();
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-sm-12 col-12 pr-md-5 text-center"><span><img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']?>"/>
              </span></div>
...
-->           
<a class="btn px-5 py-2 orange_btn" href="#prodfeed-blue-banner-bottom">
  Get a Demo
</a>
</div>
...
<section>
  ...
  <div class="prodfeed-blue-banner" id="prodfeed-blue-banner-bottom">
