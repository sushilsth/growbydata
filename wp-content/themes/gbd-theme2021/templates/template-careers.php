...
?>
<?php get_header(); ?>
<div class="gbd-careers-page gbd-content gbd-space">
            ...
            <div class="container-small text-center">
                ...
                <div class="row">
                    <div class="col-md-12 overview-content">
                        ...
                        wp_reset_query();
                        ?>
                        <a href="#" onclick="event.preventDefault()" class=" btn orange_btn overview-btn" data-toggle="modal" data-target="#careerContactform"><?php esc_html_e('Contact us about a job', 'growbydata-site'); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mb-150">
    <div class="container">
        <div class="container-small">
            <a id="scroll-down"></a>
            <div class="row">
                <div class="col-md-12 overview-career">
                                ...
                                <div class="accordion-group career-box">
                                    ...
                                    <div class="accordion-body collapse" id="collapse-<?php echo $i; ?>">
                                        <div class="accordion-inner">
                                            <?php the_content(); ?>
                                            <a href="#" onclick="event.preventDefault()" class="btn orange_btn btn-default" data-toggle="modal" data-target="#gbdCareer"><?php esc_html_e('Learn more', 'growbydata-site'); ?></a>
                                        </div>
                                    </div>
                                </div>
                                <?php
...
<script type="text/javascript">
        ...
        jQuery('.orange_btn').bind('click',function(){
