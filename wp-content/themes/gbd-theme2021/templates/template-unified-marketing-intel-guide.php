<?php
/*
  Template Name: Marketing Intelligence guide for brand
 *
        ...
        <section class="gbd-talk-to-expert-top-section">
         <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
              <div class="gbd-talk-to-expert-rt-content checkbox-orange" id="gbd-talk-to-expert-rt-content">
                    ...
                    <script>
                      var downloadPDF = function(){
                        a = document.createElement("a");
                            a.href =  "<?php echo get_template_directory_uri() . '/assets/pdf/Unified Marketing Intelligence Guide 2021.pdf'?>", a.download = "Unified Marketing Intelligence Guide 2021.pdf", document.body.appendChild(a), a.click(), document.body.removeChild(a)
                     ...
                     function HubspotFormLoad(file) {
                      ...
                      script.onload = function() {
                              ...
                              if (document.querySelectorAll("#gbd-talk-to-expert-hb-form .hbspt-form").length == 0) {
                                  ...
                                  script1.innerHTML = "hbspt.forms.create({portalId: '5372895',formId: '<?php includeWithVariables('hubspotForms.php', array('formName'=>'Unified Marketing Intel Page Form')); ?>',onFormSubmit: downloadPDF})";
