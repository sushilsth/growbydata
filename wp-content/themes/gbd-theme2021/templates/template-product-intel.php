<?php
/*
Template Name: Product Intelligence
 *
...
<div class="gbd-ad-intel-template gbd-solution-template">
  ...
  <section>
    <!-- GBD Static Banner -->
    <div class="bg_cover-banner marketplace-banner search-banner product-banner text-white">
      <?php the_field('Productintel slider'); ?>
    </div>
  </section>
  <!-- GBD Static Banner -->
  ...
  <div class=" text-white even background-light block-2">
   <?php if (have_rows('second-block')): ?>
    ...
    while (have_rows('second-block')): the_row();
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-12  col-sm-12 mb-4 pr-md-5 mb-md-0 pr-md-5 align-self-center">
            <div class="right-text-list text-left align-self-center">
              <h2 class="pb-3"><?php echo $title; ?> 
            </h2>
            <div class="list-top"><?php echo $listing; ?></div>
        ...
        <div class="col-md-6 col-12 col-sm-12 align-self-center pl-md-4"><span><img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']?>"/>
        </span></div>
...
<!-- <a class="btn px-5 py-2 orange_btn" href="<?php //echo esc_url( $getdemo ); ?>">
-->

<a class="btn px-5 py-2 orange_btn" href="#prodintel-blue-banner-bottom">
 Get a Demo
</a>
</div>
</div>
...
<section><div class="text-white odd background-light block-4">
 <?php if (have_rows('foruth-block')): ?>
  ...
  while (have_rows('foruth-block')): the_row();
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-12 mb-4 pr-md-5 mb-md-0 py-5 align-self-center">
          <div class="right-text-list text-left align-self-center">
            <h2 class="pb-3"><?php echo $title; ?> 
          </h2>
          <div class="list-top"><?php echo $listing; ?></div>
      ...
      <div class="col-md-6 col-sm-12 align-self-center pl-md-4"><span><img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']?>"/>
      </span></div>
...
<section>
  ...
  <section>
    ...
    <div class="prodintel-blue-banner" id="prodintel-blue-banner-bottom">
