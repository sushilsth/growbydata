<?php
/*
  Template Name: Search Tunnel Vision for brands
 *
                    ...
                    <script>
                      var downloadPDF = function(){
                        a = document.createElement("a");
                            a.href =  "<?php echo get_template_directory_uri() . '/assets/pdf/Search Tunnel Vision for brands.pdf'?>", a.download = "Search Tunnel Vision for brands.pdf", document.body.appendChild(a), a.click(), document.body.removeChild(a)
                     ...
                     function HubspotFormLoad(file) {
                      ...
                      script.onload = function() {
                              ...
                              if (document.querySelectorAll("#gbd-talk-to-expert-hb-form .hbspt-form").length == 0) {
                                  ...
                                  script1.innerHTML = "hbspt.forms.create({portalId: '5372895',formId: '<?php includeWithVariables('hubspotForms.php', array('formName'=>'Search Tunnel Vision for brands Form')); ?>',onFormSubmit: downloadPDF})";
