<?php
/*
Template Name: Repricing Template
 *
...
<div class="gbd-default-template gbd-enforce-map gbd-repricing">
  ...
  <div class="gbd-enforce-banner">
   ...
   <div class="gbd-enforce-map-mid"> 
    ...
    <div class="gbd-default-circle-block clearfix">
      <?php if (have_rows('gbd-repricing-block')): ?>

        <div class="gbd-enforce-map-blocks gbd-repricing-blocks clearfix">
          <?php
          $i = 1;
          while (have_rows('gbd-repricing-block')): the_row();
            $title = get_sub_field('gbd-repricing-title');
            $image = get_sub_field('gbd-repricing-image');          
            $description = get_sub_field('gbd-repricing-description');
            ?>
    ...
    <div class="row">
      <div class="col-md-5 col-sm-5 fadeIn" style="padding-right: 0;">
        <div class="gbd-enforce-map-monitoring-lt">
          <h2>What is included with Price Intelligence Software?</h2>
          <?php if (have_rows('gbd-repricing-li-block')): ?>
            <div class="gbd-leftside-contents">
              <?php
              $i = 1;
              while (have_rows('gbd-repricing-li-block')): the_row();
                $description = get_sub_field('description');
                ?>
                <div class="gbd-repricing-li gbd-repricing-li-<?php echo $i; ?>"> 
     ...
     <div class="col-md-7 col-sm-7 fadeIn" style="padding-left: 0;">
      <span class="map-graphics">
        <picture>
          <source type="image/webp" srcset="<?php echo get_template_directory_uri()?>/images/repricing-graph.webp">
            <img src="<?php echo get_template_directory_uri()?>/images/repricing-graph.png" alt="repricing-graph"> 
          </picture>
        </span>
      </div>
          ...
          <div class="gbd-inner-page-wrapper">
            <div class="gbd-enforce-map-faq-accordin gbd-accordin">
              <h2 style="margin-bottom:30px;display:block;width:100%;margin-top:10px">
                <!-- <?php echo get_field('Repricing_faq_accordion_title'); ?> -->
                Frequently Asked Questions
              </h2>
              <div class="accordion" id="accordion">
                <?php
// Check rows exists.
                if( have_rows('repricing_faq') ):
    // Loop through rows.
                  $i = 0;
                  while( have_rows('repricing_faq') ) : the_row();
                    $i++;
        // Load sub field value.
                    ?>
                    <div class="card">
    ...
    <div class="container">
      <div class="gbd-enforce-consultation-form">
        ...
        <div id="schedule-free-consultation" class="contact-form schedule-free-consultation">
          ...
          <script>
            hbspt.forms.create(<?php includeWithVariables('hubspotForms.php', array("formName"=>"Repricing Schedule Free Consultation Form")); ?>);
          </script>
