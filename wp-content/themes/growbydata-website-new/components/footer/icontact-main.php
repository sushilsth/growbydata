<div id="maillistbtn" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="maillistLabel"  aria-hidden="true">
    <div class="modal-dialog gbd-pop-block" role="document">
        <div class="modal-content">
            <div class="form-header">
                        <h3>Get our Latest Updates</h3>
                        <label>Subscribe Our Blog</label>
                    </div>
...
<!--code added for hubspot live ends here-->


<!--code added for test hubspot-->
<!--[if lte IE 8]>
<script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/v2-legacy.js"></script>
<![endif]-->
<!-- <script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/v2.js"></script>
<script>
  hbspt.forms.create({
    portalId: "6867561",
    formId: "db6bc87b-dd04-49cb-ad2a-9a00716f21a1"
});
</script> -->
<!--code added for test hubspot ends here-->
